...
@section('content')
    <main class="relative flex flex-col w-full max-w-[1280px] px-[75px] mx-auto mt-[50px] mb-[62px]">
        ...
        <form action="{{ route('booking.save-passenger-details', $flight->flight_number) }}" class="flex gap-[30px] mt-[30px]" method="POST">
            @csrf
                    ...
                    <div class="accordion-content p-5 pt-0 flex flex-col gap-5">
                        ...
                        <div class="flex justify-between">
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-lg leading-[27px] mt-[2px]">12%</p>
                            </div>
                            <div>
                        ...
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <p class="font-semibold text-lg leading-[27px] mt-[2px]">{{ 'Rp ' . number_format($tier->price * count($transaction['selected_seats']) * 0.12, 0, ',', '.') }}</p>
                            </div>
                            <div>
                                <p class="text-sm text-garuda-grey">Grand Total</p>
                                <p class="font-bold text-2xl leading-9 text-garuda-blue mt-[2px]">{{ 'Rp ' . number_format($tier->price * count($transaction['selected_seats']) * 1.12, 0, ',', '.') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
