        ...
        <div class="flex">
                    ...
                    <div class="accordion-content p-5 pt-0 flex flex-col gap-5">
                        ...
                        <div class="flex justify-between">
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-lg leading-[27px] mt-[2px]" id="tax">12%</p>
                            </div>
                            <div>
            ...
            <div id="Plane" class="relative flex w-[558px] shrink-0 mt-[30px] mx-auto">
                ...
                <div class="relative flex flex-col justify-end">
                    ...
                    <form action="{{ route('booking.confirm-seat', $flight->flight_number) }}" method="POST" class="relative px-[56px] pb-[60px]" id="form-seat">
                        @csrf
                        ...
                        <label class="group relative flex w-[55px] h-[52.25px] shrink-0 @if ($tier->class_type == 'business') [&:nth-child(4n+2)]:mr-10 @else [&:nth-child(6n+3)]:mr-[46px] @endif"
                            ...
                            <p class="relative flex items-center justify-center h-full w-full pb-[8.25px] text-center font-semibold text-[16.5px] leading-[24.75px] text-premiere-black group-has-[:checked]:text-white">
                                {{ $seat->name }}
                            </p>
                        </label>     
                        @endforeach
...
<script src="{{ asset('assets/js/chose-seat.js') }}">
</script>
@endsection